...
<html><head>
	<meta charset="utf-8">
	<title>Jurisdicciones - Editar Registro</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="icon" type="image/png" href="../../icons/actions/im-status-message-edit.png" />
	<?php skeleton();?>
...
<div class="panel panel-info" >
  <div class="panel-heading">
    <h2 class="panel-title text-center text-default "><span class="pull-center "><img src="../../icons/actions/im-status-message-edit.png"  class="img-reponsive img-rounded"> Editar Escalafón</h2>
  </div>
