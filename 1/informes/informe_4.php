<?php include "../../connection/connection.php";
	...
	$sql = "select organismo, count(genero) as mujeres from contratos where genero = 'Femenino' group by organismo";
	$query = mysqli_query($conn,$sql);
	while($row = mysqli_fetch_array($query)){
	    $organismos[] = $row['organismo'];
	    $cantidad[] = $row['mujeres'];
	}
	$data1 = json_encode($organismos);
	$data2 = json_encode($cantidad);
...
<h2 >Informe</h2>
<h3 >Cantidad de Mujeres Contratadas por Organismo</h3><hr>
<div>
